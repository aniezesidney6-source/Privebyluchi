            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 28 }}>
              {SERVICES.map(s => (
                <div key={s.id}
                  ...
                  <div style={{ color: TEXT_MUTED, fontSize: 11, lineHeight: 1.5, marginBottom: 8 }}>{s.desc}</div>
                  <div style={{ color: GOLD_DIM, fontSize: 10, letterSpacing: 1 }}>⏱ {s.duration}</div>
                </div>
              ))}
            </div>
              ...
              {[
                ...
                <div key={label} style={{
                  ...
                  <span style={{
                    ...
                    fontSize: 13, fontWeight: String(label).startsWith("Deposit") ? 700 : 400,
                  }}>{value}</span>
                </div>
              ))}
            </div>
