          ...
          <div>
            ...
            <div style={{ marginBottom: 8 }}>
              ...
              <input
                ...
                onChange={e => {
                  ...
                  if (val < minDate) {
                    ...
                    setTime("");
                    setDateError(false);
                    alert("Bookings must be made at least 48 hours in advance. Please choose a later date.");
                    return;
                  }
                  setDate(val);
                  setTime("");
              ...
              <div style={{
                ...
                <span style={{ color: TEXT_MUTED, fontSize: 12, fontWeight: 500 }}>
                  Bookings must be made at least <strong style={{ color: TEXT }}>48 hours in advance.</strong> Earlier dates are unavailable.
                </span>
              </div>
            </div>
            ...
            {dateError && (
              <div style={{
                ...
                borderRadius: 2, padding: "12px 16px", marginTop: 8, marginBottom: 16,
...
Notes: ${form.notes || "None"}
                  ...
                  if (res.ok) {
                    // Only lock the date if email notification succeeded
                    try {
                      ...
                      // Supabase save failed — don't block the user, just continue
                    }
                    setSubmitted(true);
                  } else {
                    // Email failed — date stays open, user can retry
                    setSendError(true);
                  }
                } catch {
                  setSendError(true);
